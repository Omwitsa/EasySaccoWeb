...
{
    public partial class AppraisalRPT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                da = new WARTECHCONNECTION.cConnect().ReadDB2("SELECT * from APPRAISAL1 where memberno='" + MemberNo + "'");
                DataSet ds = new DataSet();
                da.Fill(ds, "VWappraisRPT");
                ReportDocument rd = new ReportDocument();
                string path = Server.MapPath("~\\easysacco_reports\\LoanAppraisal.rpt");
                rd.Load(path);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            (CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Response, true, "AppraisalRpt");
        }
    }
}