...
{
    public partial class AppliedLoans : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load("C:\\Windows\\Temp\\Applied Loans.rpt");
               ...
               // ReportDocument rd = new ReportDocument();
                //string path = Server.MapPath("~\\easysacco_reports\\Applied Loans.rpt");
                //rd.Load(path);
                ////rd.SetDataSource(ds.Tables[0]);
                ////rd.SetParameterValue("APPLICATIONS DATE", MemberNo);
                //CrystalReportViewer1.ReportSource = rd;
                //CrystalReportViewer1.DataBind();
