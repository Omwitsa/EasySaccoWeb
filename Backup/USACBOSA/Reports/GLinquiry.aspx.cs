    ...
    public partial class GLinquiry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string path = Server.MapPath("~\\easysacco_reports\\GeneralLedgers.rpt");
                rd.Load(path);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            (CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Response, true, "GeneralLedgers");
        }
    }
}