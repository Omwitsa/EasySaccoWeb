...
{
    public partial class LoanScheduleReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                da = new WARTECHCONNECTION.cConnect().ReadDB2("SELECT * from LOANSCHD where memberno='" + MemberNo + "'");
                DataSet ds = new DataSet();
                //da.Fill(ds, "vwShareStatement");
                ReportDocument rd = new ReportDocument();
                string path = Server.MapPath("~\\easysacco_reports\\Loan Schedule.rpt");
                rd.Load(path);
                //rd.SetDataSource(ds.Tables[0]);
                rd.SetParameterValue("MNo", MemberNo);
        ...
        //    da.Fill(ds, "vwShareStatement");
        //    ReportDocument rd = new ReportDocument();
        //    string path = Server.MapPath("~\\easysacco_reports\\ShareStatement.rpt");
        //    rd.Load(path);
        //    rd.SetDataSource(ds.Tables[0]);
        //    rd.SetParameterValue("MNo", MemberNo);
        //    CrystalReportViewer1.ReportSource = rd;
