<%@ Page Title="" Language="C#" MasterPageFile="~/ClientAdmin/ClientAdmin.Master" AutoEventWireup="true" CodeBehind="MembershipRegistration.aspx.cs" Inherits="USACBOSA.ClientAdmin.MembershipRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="Label18" runat="server" Text=" County:" Font-Bold="False" 
                        Font-Names="Tahoma" Font-Size="10pt" ForeColor="#000066" 
                        style="color: #666699; float: right;"></asp:Label>
                            </td>
                <td class="style36">
    ...
    <asp:Label ID="Label8" runat="server" Text="Surname:" Font-Bold="False" Font-Names="Tahoma" 
                        Font-Size="10pt" ForeColor="#000066" style="float: right"></asp:Label>
                                </td>
                <td class="style58">
    ...
    <asp:TextBox ID="txtPhoneNo" runat="server" Width="110px" AutoPostBack="True" 
                ...
                <asp:Label ID="Label15" runat="server" Text="DOB:" Font-Bold="False" 
                        Font-Names="Tahoma" Font-Size="10pt" ForeColor="#000066" 
                        style="float: right" Width="31px"></asp:Label>
                                </td>
                <td class="style58">
                ...
                <td class="style40">
                    <asp:Label ID="Label27" runat="server" Font-Bold="False" Font-Names="Tahoma" 
                        Font-Size="10pt" ForeColor="#000066" Text="Age:" style="float: right"></asp:Label>
                            </td>
                <td class="style36">
    ...
    <asp:Label ID="Label20" runat="server" Text="Email:" Font-Bold="False" 
            ...
            <tr>
                <td class="style41">
                                <asp:Label ID="Label24" runat="server" ForeColor="#000066" style="float: right" 
                ...
                <td class="style60" colspan="2">
                                <asp:Label ID="Label25" runat="server" ForeColor="#000066" style="float: right" 
            ...
            <tr>
                ...
                <asp:Label ID="Label11" runat="server" Text="Registration Date:"  
                        Font-Names="Tahoma" Font-Size="10pt" ForeColor="#000066" style=" float: right;" 
                ...
                <td class="style41">
                    <asp:Button ID="btnSave" runat="server" Text="Save" onclick="btnSave_Click" 
                        ...
                        Height="27px" BorderColor="Silver" ForeColor="Black" BackColor="#33CCCC" 
                                            style="float: right" Enabled="False" />
                </td>
