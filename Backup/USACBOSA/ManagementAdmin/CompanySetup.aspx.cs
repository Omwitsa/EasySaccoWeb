    ...
    public partial class CompanySetup : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string update = "set dateformat dmy update company set CompanyName='" + txtCompanyName.Text + "',NoEmployees='" + txtNoUsers.Text + "',NoYears='" + txtNoYears.Text + "',Email='" + txtEmailAddress.Text + "',Contactperson='" + TextBox3.Text + "',type='" + type + "',Telephone='" + txtTelephone.Text + "',Location='" + TextBox1.Text + "',Address='" + txtAddress.Text + "',AuditID='" + Session["mimi"].ToString() + "'";
