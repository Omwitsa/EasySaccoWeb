    ...
    public partial class Journal_Posting : System.Web.UI.Page
    {
        ...
        protected void cmdPostJournal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Journal has been Posted Successfully');", true);
                WARSOFT.WARMsgBox.Show("Journal has been Posted Successfully");               
                getJVnumber();
                txtTotalCr.Text = "0";
                txtTotalDr.Text = "0";
               // Clear();
