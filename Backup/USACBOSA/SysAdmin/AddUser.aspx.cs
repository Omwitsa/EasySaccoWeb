    ...
    public partial class AddUser : System.Web.UI.Page
    {
        ...
        protected void Button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string update = "Set dateformat dmy update UserAccounts1 set userstatus='" + userstatus + "', UserLoginID='" + loginID + "',UserName='" + usrName + "',UserGroup='" + UserGroup + "',DepCode='" + branchcode + "',superuser='" + maze1 + "',Department='" + Branch + "',euser='" + mimi + "' where UserLoginID='" + txtUserLoginId.Text.Trim() + "'";
