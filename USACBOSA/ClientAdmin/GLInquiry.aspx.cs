...
namespace USACBOSA.ClientAdmin
{
    public partial class GLInquiry : System.Web.UI.Page
    {
        ...
        private void LoadGlTransactionsQuery()
        {
            ...
            getGlBalance(txtAccno.Text, Convert.ToDateTime(dtpFromdate.Text), Convert.ToDateTime(dtpFromdate.Text));
        ...
        private void LoadTransactions()
        {
            ...
            if (dr1.HasRows)
                while (dr1.Read())
                {
                    ...
                    string DocumentNo = dr1["DocumentNo"].ToString();
                    string chequeno = dr1["chequeno"].ToString();
                    string TDescription = dr1["TDescription"].ToString();
        ...
        protected void btnAccountStatement_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Response.Redirect("~/Reports/Glinquiry.aspx");
                }
            }
            catch (Exception ex)
            {
