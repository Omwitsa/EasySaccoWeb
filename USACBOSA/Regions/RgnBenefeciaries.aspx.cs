...
{
    public partial class RgnBenefeciaries : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            try
            {
                ...
                string todata = "set dateformat dmy insert into kin(MemberNo,KinNames,KinNo,Address,IDNo,Relationship,HomeTelNo,Witness,Percentage,OfficeTelNo,SignDate,KinSigned,AuditID,AuditTime,Comments)values('" + memberno + "','" + KinNames + "','" + kinno + "','" + address + "','" + idno + "','" + Relationship + "','" + HomeTelNo + "','" + Witness + "','" + Percentage + "','" + OfficeTelNo + "','" + SignDate + "','" + kinsigned + "','" + auditid + "','" + audittime + "','" + Comments + "')";
                new WARTECHCONNECTION.cConnect().WriteDB(todata);

                string audittrans = "set dateformat dmy insert into AUDITTRANS(TransTable,TransDescription,TransDate,Amount,AuditTime,AuditID)values('kin','Added kin kinno " + kinno + "','" + System.DateTime.Today + "','0','" + System.DateTime.Now.ToString("hh:mm") + "','" + Session["mimi"].ToString() + "')";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string audittrans = "set dateformat dmy insert into AUDITTRANS(TransTable,TransDescription,TransDate,Amount,AuditTime,AuditID)values('kin','Updated kin kinno " + kinno + "','" + System.DateTime.Today + "','0','" + System.DateTime.Now.ToString("hh:mm") + "','" + Session["mimi"].ToString() + "')";
                new WARTECHCONNECTION.cConnect().WriteDB(audittrans);
