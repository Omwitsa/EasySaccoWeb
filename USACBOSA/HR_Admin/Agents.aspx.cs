...
namespace USACBOSA.HR_Admin
{
    ...
    {
        System.Data.SqlClient.SqlDataReader DR3, dr;
        ...
        private void LoadAgents()
        {
            try
            {
                string datatable = "select Names,Gender,StaffCode [Staff Code],IdNo [Id Number],Occupation,MobileNo,Branchname Station,HomeAddress [Home Address],Town from Agents order by Recruitdate desc";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string save = " set dateformat dmy Insert into Agents(Names,Gender,StaffCode,Occupation,branchname,IdNo,LandPhone,MobileNo,HomeAddress,Town,Recruitdate,AuditId,AuditTime) Values('" + TextBox1.Text + "','" + DropDownList1.Text + "','"+txtStaffCode.Text+"','"+txtOccupation.Text+"','"+cboStation.Text+"','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox2.Text + "','" + Session["mimi"].ToString() + "','" + System.DateTime.Now.ToString("dd/MM/yyyy") + "')";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string update = "set dateformat dmy Update Agents  set staffcode='"+txtStaffCode.Text+"',occupation='"+txtOccupation.Text+"',branchname='"+cboStation.Text+"', Names='" + TextBox1.Text + "',Gender='" + DropDownList1.Text + "',LandPhone='" + TextBox5.Text + "',MobileNo='" + TextBox6.Text + "',HomeAddress='" + TextBox7.Text + "',Town='" + TextBox8.Text + "' where IdNo='" + TextBox4.Text + "'";
                    ...
                    LoadAgents();
                    clearTexts();
                    WARSOFT.WARMsgBox.Show("" + TextBox1.Text + " Details Updated Successfully");
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                txtStaffCode.Text = GridView1.SelectedRow.Cells[3].Text;
                TextBox4.Text = GridView1.SelectedRow.Cells[4].Text;
                txtOccupation.Text = GridView1.SelectedRow.Cells[5].Text;
