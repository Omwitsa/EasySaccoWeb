            ...
            try
            {
                ...
                if (dr.HasRows)
                    while (dr.Read())
                    {
                        ...
                        int nextno = maxno;
                        txtVoucherNo.Text = "VNO" + (System.DateTime.Today).Day + (System.DateTime.Today).Month + Right((((System.DateTime.Today).Year).ToString()), 2) + "-" + ((nextno).ToString()).PadLeft(3, '0');
                    }
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        string MemberNames = dr["membernames"].ToString();
                        string LoanShareCode = dr["LoanNo"].ToString();
                        ...
                        string Purpose = dr["LoanType"].ToString();
                        string Narration = dr["LoanType"].ToString();
                ...
                if (dr2.HasRows)
                {
                    while (dr2.Read())
                    {
                        string MemberNo = dr2["MemberNo"].ToString();
                        string MemberNames = dr2["membernames"].ToString();
                        string LoanShareCode = dr2["LoanNo"].ToString();
                        ...
                        string Purpose = dr2["LoanType"].ToString();
                        string Narration = dr2["LoanType"].ToString();
                ...
                if (dr3.HasRows)
                {
                    while (dr3.Read())
                    {
                        string MemberNo = dr3["memberno"].ToString();
                        string MemberNames = dr3["membernames"].ToString();
                        ...
                        string Purpose = dr3["purpose"].ToString();
                        string Narration = dr3["purpose"].ToString();
                ...
                if (dr4.HasRows)
                {
                    while (dr4.Read())
                    {
                        ...
                        string MemberNames = dr4["membernames"].ToString();
                        string LoanShareCode = dr4["RefCode"].ToString();
                        ...
                        string Purpose = dr4["refundItem"].ToString();
                        string Narration = dr4["refundItem"].ToString();
