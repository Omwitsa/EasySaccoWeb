...
{
    public partial class ShareStatementReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //da = new WARTECHCONNECTION.cConnect().ReadDB2("SELECT * from vwShareStatement  order by contrdate");
               // DataSet ds = new DataSet();
                //da.Fill(ds, "vwShareStatement");
                ReportDocument RptDoc = new ReportDocument();
                RptDoc.Load("C:\\Windows\\Temp\\ShareStatement.rpt");
