    ...
    public partial class AddUser : System.Web.UI.Page
    {
                ...
                if (txtPassword1.Text == this.txtPassword2.Text)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (pcomplexity == 0)
                            {
                                string inDB = "Set dateformat dmy Insert into UserAccounts1 (UserLoginID,UserName,PassExpire,UserGroup,DepCode,DateCreated,expiryDate,password,superuser,Department,euser)VALUES('" + loginID + "','" + usrName + "','" + expDate + "','" + UserGroup + "','" + branchcode + "','" + dateCreated + "','" + expiryDate + "','" + Password + "','" + maze1 + "','" + Branch + "','" + mimi + "')";
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (UserGroup == "Customer Service")
                {
                    maze1 = "4";
                }
                if (UserGroup == "Branch Managers")
                {
                    maze1 = "5";
                }
                dateCreated = System.DateTime.Now.ToString();
                ...
                if (txtPassword1.Text == this.txtPassword2.Text)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (pcomplexity == 0)
                            {
                                string inDB = "Set dateformat dmy Insert into UserAccounts1 (UserLoginID,UserName,PassExpire,UserGroup,DepCode,DateCreated,expiryDate,password,superuser,Department,euser,count,passwordStatus,userstatus,vendor_ID)VALUES('" + loginID + "','" + usrName + "','" + expDate + "','" + UserGroup + "','" + branchcode + "','" + dateCreated + "','" + expiryDate + "','" + Password + "','" + maze1 + "','" + Branch + "','" + mimi + "','0','CHANGE','ENABLED',0,)";
                                new WARTECHCONNECTION.cConnect().WriteDB(inDB);
                                WARSOFT.WARMsgBox.Show("User account has been created..");
                                DropDownList1.Enabled = true;
                                loadgrid();
        ...
        protected void Button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (UserGroup == "Finance Officer")
                {
                    maze1 = "2";
                }
                else if (UserGroup == "Loans Officer")
                {
                    maze1 = "3";
                }

                else if (UserGroup == "Customer Service")
                {
                    maze1 = "4";
                }
                else
                ...
                string update = "Set dateformat dmy update UserAccounts1 set UserLoginID='" + loginID + "',UserName='" + usrName + "',UserGroup='" + UserGroup + "',DepCode='" + branchcode + "',superuser='" + maze1 + "',Department='" + Branch + "',euser='" + mimi + "' where UserLoginID='" + txtUserLoginId.Text.Trim() + "'";
        ...
        protected void Button8_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                WARSOFT.WARMsgBox.Show("Password Successfully Reset!");
            }
        }
    }
}