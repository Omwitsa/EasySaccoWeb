...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="Label5" runat="server" Text="Payment Posting - MPA" Font-Bold="True" 
      ...
      <table style="width:100%;">
                 ...
                 <tr>
                     <td align="right" class="auto-style2">Group Code:</td>
                     <td class="auto-style3">
                         <asp:TextBox ID="groupCode" runat="server"></asp:TextBox>
                     </td>
                     <td class="auto-style2" colspan="3">
                         <asp:TextBox ID="groupName" runat="server" Width="290px"></asp:TextBox>
                     </td>
