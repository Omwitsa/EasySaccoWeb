<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceAdmin/FinanceAdmin.Master" AutoEventWireup="true" CodeBehind="LoansInquiry.aspx.cs" Inherits="USACBOSA.FinanceAdmin.LoansInquiry" %>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td>
                        <asp:Button ID="Button3" runat="server" Text="Member Loan Schedule" 
                            onclick="Button3_Click" style="font-weight: 700" />
                    </td>
                    <td>
