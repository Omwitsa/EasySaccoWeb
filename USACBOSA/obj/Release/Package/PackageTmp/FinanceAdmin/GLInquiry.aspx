<%@ Page Title="" Language="C#" MasterPageFile="~/FinanceAdmin/FinanceAdmin.Master" AutoEventWireup="true" CodeBehind="GLInquiry.aspx.cs" Inherits="USACBOSA.FinanceAdmin.GLInquiry" %>
    ...
    <asp:Label ID="Label5" runat="server" Text="General Ledger Inquiry" Font-Bold="True" 
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="style1">
                    <asp:Label ID="Label8" runat="server" Text="To Date" 
            ...
            <tr>
                ...
                <td class="style1">
                    <asp:Label ID="Label10" runat="server" Text="Book Balance" style="float: right"></asp:Label>
                </td>
                <td class="style4">
