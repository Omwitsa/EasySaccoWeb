    ...
    <table frame="box" style="width:100%;">
        ...
        <tr>
            <td class="auto-style5">Loan No.<br />
                <asp:TextBox ID="txtLoanNo" runat="server" Width="151px"></asp:TextBox>
            </td>
            <td class="auto-style6">Group Code<br />
                <asp:TextBox ID="txtGroupCode" runat="server" Width="151px" OnDataBinding="txtGroupCode_DataBinding" OnTextChanged="txtGroupCode_TextChanged" AutoPostBack="True"></asp:TextBox>
            </td>
