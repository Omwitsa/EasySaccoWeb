...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr style="color: Maroon; height: 2px;" />
        ...
        <tr>
            ...
            <td class="style15">
                <asp:DropDownList ID="DropDownUserTypes" runat="server" style="float: left;" Font-Bold="False" 
        ...
        <tr>
            ...
            <td class="style15">
                <asp:DropDownList ID="DropDownList1" style="float: left;" runat="server" Width="150px">
                </asp:DropDownList>
            </td>
            <td class="style24">
        ...
        <tr>
            ...
            <td class="style22">
                <asp:TextBox ID="txtPassword1" runat="server"   style="float: left;" TextMode="Password" Width="150px"></asp:TextBox>
            </td>
            <td class="style25">
        ...
        <tr>
            <td class="style6">
                <asp:Label ID="Label18" runat="server"  style="color: #000000; float: right;" Font-Bold="true"  Text="Group:"></asp:Label>
            </td>
            <td class="style22">
                <asp:DropDownList ID="DropDownList2" style="float: left;" runat="server" Height="26px" Width="150px">
                </asp:DropDownList>
            </td>
            <td class="style25">
